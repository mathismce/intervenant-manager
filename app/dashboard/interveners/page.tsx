...
import { CreateIntervener, RegenerateAllKeys } from '@/app/ui/dashboard/intervener/button';
...
export default function IntervenerPage() {
  ...
  const handleUpdateIntervenant = (updatedIntervenant: Intervenant) => {
    setIntervenants((prevIntervenants) =>
      prevIntervenants.map((intervenant) =>
        intervenant.id === updatedIntervenant.id ? updatedIntervenant : intervenant
      )
    );
  };
  ...
  return (
    <div>
      <div className='flex justify-between'>
        ...
        <RegenerateAllKeys></RegenerateAllKeys>
      </div>
      <IntervenantsTable
        ...
        onUpdate={handleUpdateIntervenant}
      />
    </div>
  );
}